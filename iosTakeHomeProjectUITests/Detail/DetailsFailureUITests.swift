...
//
//  Created by Khawla Zarrami on 26/01/2026.
//
...
final class DetailsFailureUITests: XCTestCase {
    ...
    func test_alert_is_shown_when_screen_fails_to_loads() {
        ...
        let placeholderPredicate = NSPredicate(format: "label CONTAINS '-'")
        let placeholderItems = app.staticTexts.containing(placeholderPredicate)
