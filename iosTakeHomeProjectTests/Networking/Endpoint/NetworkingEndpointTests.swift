...
//
//  Created by Khawla Zarrami on 22/10/2025.
//
...
final class NetworkingEndpointTests: XCTestCase {
    ...
    func test_with_people_endpoint_request_is_valid() {
        ...
        XCTAssertEqual(endpoint.url?.absoluteString ,"https://reqres.in/api/users?page=1&delay=2", "The generated url does much our endpoint" )
    }
    ...
    func test_with_detail_endpoint_request_is_valid() {
        ...
        XCTAssertEqual(endpoint.url?.absoluteString, "https://reqres.in/api/users/1?delay=2", "The generated url does much our endpoint")
    }
    ...
    func test_with_create_endpoint_request_is_valid() {
        ...
        XCTAssertNil(endpoint.queryItems, "The query items should be nil")
        XCTAssertEqual(endpoint.url?.absoluteString, "https://reqres.in/api/users?delay=2", "The generated url does much our endpoint")
