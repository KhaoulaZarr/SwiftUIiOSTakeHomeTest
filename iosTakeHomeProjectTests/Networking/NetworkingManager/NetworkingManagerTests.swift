...
final class NetworkingManagerTests: XCTestCase {
    ...
    func test_with_successful_response_response_is_valid() async throws{
        ...
        let staticJSON = try StaticJsonMapper.decode(file: "UserStaticsData", type: UsersResponse.self)
    ...
    func test_with_unsuccessful_response_code_in_invalid_range_is_invalid() async  {
        ...
        do {
            ...
            XCTAssertEqual(networkingError, NetworkingManager.NetworkingError.invalidStatusCode(statusCode: invalidStatusCode), "Error should be a networking Error which throws in invalid status code")
